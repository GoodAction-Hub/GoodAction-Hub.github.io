...
export const TimelineItem = forwardRef<HTMLDivElement, TimelineItemProps>(
  (props, ref) => {
    ...
    const position =
      totalEvents > 1 ? (index / (totalEvents - 1)) * 80 + 10 : 50;
    ...
    ${
      isActive
        ? 'bg-orange-500 border-orange-300 ring-2 ring-orange-200 scale-125'
        : isUpcoming
      ...
      <>
        ...
        >
          ...
          <div className={dateClasses}>
            ...
            >
              {deadlineDate.setZone(currentTimezone).toFormat('MM-dd')}
            </div>
          </div>
        </div>
