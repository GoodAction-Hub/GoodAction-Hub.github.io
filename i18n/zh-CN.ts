const BASE_TEXT = {
  ...
  'date.minutes': '分钟',
  'date.seconds': '秒',
  'pagination.first': '跳转到第一页',
  'pagination.previous': '跳转到上一页',
  'pagination.next': '跳转到下一页',
  'pagination.last': '跳转到最后一页',
  'calendar.title': '日历',
  ...
  'home.selector.title': 'GoodAction Hub 首页',
  'home.selector.subtitle':
    '请选择进入模块：公益慈善活动截止日期、无障碍友好美食指南 或 志愿辅导课程',
  'home.search.label': '探索',
  'home.search.aria': '搜索推荐内容',
  'home.qr.alt': 'GoodActionHub 益行汇群二维码',
  'detail.back': '返回',
  ...
  'recommend.loadFailed': '数据加载失败',
  'recommend.fetchError': '数据获取失败',
  original_timezone: '原始时区',
  ...
  'bites.ai_dialog.errors.empty': '未找到符合条件的推荐',
...
const ACTIVITIES_LIST_TEXT = {
  ...
  activities_list_text_publish_activity: '+ 发布活动',
  activities_list_text_timezone_note:
    '所有截止日期均默认转换为北京时间，如果您不知道当前所在时区，请点击时区选择器右侧的“自动检测”',
  activities_list_text_disclaimer: '*免责声明：本站数据由人工维护，仅供参考',
